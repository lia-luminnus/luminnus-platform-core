 ...
 */
export type GeminiLiveEventType = 'connected' | 'listening' | 'speaking' | 'message' | 'error' | 'end' | 'user-transcript' | 'lia-transcript' | 'generating-start' | 'generating-end' | 'chart-generated' | 'table-generated' | 'image-generated' | 'memory-saved' | 'tool-result' | 'tool-active' | 'update-available';
/**
