...
const AdminWhatsApp: React.FC = () => {
    ...
    const tabs = [
        ...
        { id: 'master', label: 'Conexão Master', icon: <Zap size={18} /> },
    ] as const;
    ...
    return (
        <div className="flex-1 overflow-hidden h-full flex flex-col bg-gray-50 dark:bg-[#0A0F1A]">
            {/* 2.1 Header */}
            <div className="p-6 lg:p-10 pb-0">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 dark:text-gray-400 mt-2 font-medium">Controle global e gestão do número mestre</p>
                    </div>
                ...
                <div className="flex gap-8 border-b border-gray-200 dark:border-white/10 mb-8">
                    {tabs.map((tab) => (
                        ...
                        >
                            ...
                            {activeTab === tab.id && (
                                <motion.span
                                    layoutId="adminWhatsappTabIndicator"
                ...
                <AnimatePresence mode="wait">
                    {activeTab === 'overview' ? (
                            ...
                            <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl overflow-hidden shadow-xl">
                                <div className="p-6 border-b border-gray-200 dark:border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4 bg-gray-50/50 dark:bg-white/[0.02]">
                                    ...
                                    <div className="flex items-center gap-3 w-full sm:w-auto">
                                        ...
                                        <select
                                            className="bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-brand-primary/50 text-gray-800 dark:text-gray-200"
                                            value={statusFilter}
                                                    ...
                                                    <tr key={tenant.id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors group cursor-pointer" onClick={() => setSelectedTenant(tenant)}>
                                                        ...
                                                        <td className="px-6 py-4 text-right">
                                                            <div className="flex items-center justify-end gap-2 text-gray-400">
                                                                <div className="p-2 hover:bg-brand-primary/20 hover:text-brand-primary rounded-lg transition-all">
                                                                    <Eye size={18} />
                                                                </div>
                                                                <div className="p-2 hover:bg-emerald-500/20 hover:text-emerald-500 rounded-lg transition-all">
                                                                    <Zap size={18} />
                                                                </div>
                                                            </div>
                                                        </td>
                        ...
                        <motion.div
                            ...
                            exit={{ opacity: 0, x: -20 }}
                        >
                            <div className="bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-3xl overflow-hidden shadow-xl min-h-[500px]">
                                <WhatsAppConnection tenantIdOverride={ADMIN_TENANT_ID} />
                            </div>
                        </motion.div>
                    )}
                </AnimatePresence>
                        ...
                        >
                            <div className="p-8">
                                <div className="flex justify-between items-start mb-10">
                                    ...
                                    <button
                                        onClick={() => setSelectedTenant(null)}
                                        className="p-3 hover:bg-gray-100 dark:hover:bg-white/10 rounded-2xl transition-all text-gray-500"
                                    >
                                        <XCircle size={24} />
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center gap-3 mb-10">
                                    ...
                                    <span className="text-[10px] font-bold text-gray-500 font-mono text-gray-400">ID: {selectedTenant.id}</span>
                                </div>
                                ...
                                <div className="space-y-8">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="p-4 rounded-2xl bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/5">
                                            ...
                                            <div className="flex items-center gap-2 text-emerald-400 text-emerald-500">
                                                <Activity size={16} />
                                                <span className="text-sm font-bold uppercase tracking-wider">{selectedTenant.quality}</span>
                                            </div>
                                        </div>
                                    </div>
