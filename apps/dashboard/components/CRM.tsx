...
const CRM: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-gray-50 dark:bg-dark-bg transition-colors duration-500">
            ...
            <div className="flex-1 p-4 md:p-8 pt-2 overflow-y-auto scroll-smooth">
                ...
                <AnimatePresence mode="wait">
                    {viewMode === 'kanban' ? (
                        <motion.div
                            ...
                            exit={{ opacity: 0, y: -20 }}
                            className="flex overflow-x-auto pb-8 gap-6 h-[calc(100vh-320px)] custom-scrollbar"
                        >
                            {stages.map((stage, sIdx) => (
                                <div
                                    key={stage.key}
                                    className="min-w-[280px] sm:min-w-[320px] w-full max-w-[350px] flex-shrink-0 flex flex-col"
