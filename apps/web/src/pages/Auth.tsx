        ...
        <div className="p-8 lg:p-12 flex flex-col justify-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-white/60 text-lg">
              Conecte sua conta do Google para conversar com a LIA em segundos.
            </p>
          </div>

          {/* Botão Google OAuth - Única Ação */}
          <div className="space-y-6">
            <Button
              onClick={handleGoogleSignIn}
              disabled={loading}
              type="button"
              className="w-full bg-white hover:bg-white/90 text-gray-800 font-bold shadow-xl h-14 text-lg rounded-xl flex items-center justify-center gap-3 transition-all transform hover:scale-[1.01]"
            >
            ...
            <div className="relative flex items-center py-4">
              ...
              <span className="flex-shrink mx-4 text-white/30 text-sm font-medium uppercase tracking-widest">ou use seu e-mail</span>
              <div className="flex-grow border-t border-white/10"></div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button
                type="submit"
                className="w-full bg-[#00C2FF] hover:bg-[#00C2FF]/90 text-white h-12 rounded-xl font-bold transition-all shadow-lg shadow-[#00C2FF]/10"
                disabled={loading}
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin mx-auto" /> : (isLogin ? 'Entrar na LIA' : 'Criar minha conta')}
              </Button>
            </form>
