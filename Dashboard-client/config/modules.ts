...
export const MODULE_REGISTRY: Record<ModuleId, ModuleDefinition> = {
  ...
  emails: { id: 'emails', translationKey: 'emails', icon: 'mail', path: '/emails' },
};
...
export const CATEGORY_PRESETS: Record<string, ModuleId[]> = {
  // Serviços Técnicos
  services_technical: ['dashboard', 'integrations', 'lia', 'calendar', 'crm', 'files', 'financial', 'automations', 'whatsapp_agent', 'plan', 'settings', 'support', 'emails'],

  // Profissionais Liberais
  professionals: ['dashboard', 'integrations', 'lia', 'crm', 'calendar', 'files', 'financial', 'automations', 'whatsapp_agent', 'reports', 'plan', 'settings', 'support', 'emails'],

  // Saúde & Bem-Estar
  health_wellbeing: ['dashboard', 'integrations', 'lia', 'calendar', 'medical_records', 'financial', 'files', 'crm', 'plan', 'settings', 'support', 'emails'],

  // Imobiliária & Construção
  real_estate_construction: ['dashboard', 'integrations', 'lia', 'crm', 'properties', 'calendar', 'files', 'financial', 'automations', 'plan', 'settings', 'support', 'emails'],

  // Comércio & Lojas
  commerce_retail: ['dashboard', 'integrations', 'lia', 'stock', 'sales', 'financial', 'automations', 'team', 'plan', 'settings', 'support', 'emails'],

  // Alimentação & Restaurantes
  food_restaurants: ['dashboard', 'integrations', 'lia', 'stock', 'sales', 'financial', 'team', 'plan', 'settings', 'support', 'emails'],

  // Transporte & Logística
  transport_logistics: ['dashboard', 'integrations', 'lia', 'logistics', 'stock', 'financial', 'team', 'automations', 'plan', 'settings', 'support', 'emails'],

  // Tecnologia & Software
  tech_software: ['dashboard', 'integrations', 'lia', 'projects', 'automations', 'team', 'files', 'crm', 'plan', 'settings', 'support', 'emails'],

  // Conteúdo & Criativos
  content_creatives: ['dashboard', 'integrations', 'lia', 'projects', 'files', 'crm', 'calendar', 'plan', 'settings', 'support', 'emails'],

  // Serviços Empresariais
  business_services: ['dashboard', 'integrations', 'lia', 'crm', 'financial', 'reports', 'whatsapp_agent', 'files', 'team', 'automations', 'plan', 'settings', 'support', 'emails'],

  // Educação & Treinamento
  education_training: ['dashboard', 'integrations', 'lia', 'calendar', 'files', 'crm', 'financial', 'plan', 'settings', 'support', 'emails'],

  // Outros (Personalizado)
  custom_other: ['dashboard', 'integrations', 'lia', 'crm', 'calendar', 'files', 'financial', 'plan', 'settings', 'support', 'emails'],

  // Legacy keys (backward compatibility)
  technical_services: ['dashboard', 'integrations', 'lia', 'calendar', 'crm', 'files', 'financial', 'automations', 'plan', 'settings', 'support', 'emails'],
  liberal_professionals: ['dashboard', 'integrations', 'lia', 'crm', 'calendar', 'files', 'financial', 'automations', 'reports', 'plan', 'settings', 'support', 'emails'],
  health_wellness: ['dashboard', 'integrations', 'lia', 'calendar', 'medical_records', 'financial', 'files', 'crm', 'plan', 'settings', 'support', 'emails'],
  real_estate: ['dashboard', 'integrations', 'lia', 'crm', 'properties', 'calendar', 'files', 'financial', 'automations', 'plan', 'settings', 'support', 'emails'],
  retail: ['dashboard', 'integrations', 'lia', 'stock', 'sales', 'financial', 'automations', 'team', 'plan', 'settings', 'support', 'emails'],
  food: ['dashboard', 'integrations', 'lia', 'stock', 'sales', 'financial', 'team', 'plan', 'settings', 'support', 'emails'],
  logistics: ['dashboard', 'integrations', 'lia', 'logistics', 'stock', 'financial', 'team', 'automations', 'plan', 'settings', 'support', 'emails'],
  tech: ['dashboard', 'integrations', 'lia', 'projects', 'automations', 'team', 'files', 'crm', 'plan', 'settings', 'support', 'emails'],
  creative: ['dashboard', 'integrations', 'lia', 'projects', 'files', 'crm', 'calendar', 'plan', 'settings', 'support', 'emails'],
  education: ['dashboard', 'integrations', 'lia', 'calendar', 'files', 'crm', 'financial', 'plan', 'settings', 'support', 'emails'],
...
export const getModules = (activeIds: ModuleId[]): ModuleDefinition[] => {
  ...
  const preferredOrder: ModuleId[] = [
    ...
    'settings', 'plan', 'support', 'whatsapp_agent', 'emails'
  ];
