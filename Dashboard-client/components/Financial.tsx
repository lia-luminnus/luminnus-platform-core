                                    ...
                                    <tbody className="divide-y divide-gray-200 dark:divide-white/5">
                                        {transactions.map((t) => (
                                            <tr key={t.id} className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                                                ...
                                                <td className="p-4">
                                                    <span className={`px-3 py-1 rounded-full text-xs font-semibold bg-${t.status === 'completed' ? 'green' : t.status === 'pending' ? 'yellow' : 'blue'
                                                        }-500/20 text-${t.status === 'completed' ? 'green' : t.status === 'pending' ? 'yellow' : 'blue'
                                                        }-500`}>
