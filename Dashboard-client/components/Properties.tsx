                        ...
                        <div className="mt-8 h-24 w-full max-w-5xl overflow-x-auto flex items-center justify-center gap-4 p-4 no-scrollbar z-50">
                            {activeGalleryImages.map((img, idx) => (
                                <motion.button
                                    ...
                                    className={`relative w-20 h-14 flex-shrink-0 rounded-xl overflow-hidden transition-all duration-300 ${activeImageIndex === idx ? 'ring-4 ring-brand-primary scale-110 shadow-[0_0_30px_rgba(139,92,246,0.5)]' : 'opacity-40 hover:opacity-100 grayscale hover:grayscale-0'
                                        }`}
                                >
