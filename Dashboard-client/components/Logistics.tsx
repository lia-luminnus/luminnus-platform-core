        ...
        <div className="flex flex-col h-full">
            ...
            <div className="flex-1 p-8 pt-2 overflow-y-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    {[
                        { title: 'Entregas em Andamento', value: '1,204', change: '+12%', trend: 'up' as const, icon: 'local_shipping', color: 'text-green-500', iconBg: 'bg-green-500/10' },
                        { title: 'Atrasados', value: '32', change: '+5', trend: 'up' as const, icon: 'warning', color: 'text-red-500', iconBg: 'bg-red-500/10' },
                        { title: 'Entregues', value: '8,721', change: '+8%', trend: 'up' as const, icon: 'check_circle', color: 'text-blue-500', iconBg: 'bg-blue-500/10' },
                        { title: 'Em Espera', value: '115', change: '-2', trend: 'down' as const, icon: 'pause_circle', color: 'text-yellow-500', iconBg: 'bg-yellow-500/10' },
                    ].map((stat, index) => (
